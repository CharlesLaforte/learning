...
class GameMap:
    ...
    def make_map(self, max_rooms, room_min_size, room_max_size, map_width, map_height, player, 
        ...
        # Create two rooms for demonstartion purposes
        ...
        for r in range(max_rooms):
            ...
            # run through the other rooms and see if they intersect with one
    ...
    def place_entities(self, room, entities, max_monsters_per_room, max_items_per_room):
        ...
        for i in range(number_of_monsters):
            # Choose a ranodom location in the room
            ...
            if not any([entity for entity in entities if entity.x == x and entity.y == y]):
                ...
                if item_chance < 1:
                    ...
                    item_component = Item(use_function=cast_confuse, targeting=True, targeting_message=Message(
                        'Left_click an enemy to confuse it, or right_click to cancel.', libtcod.light_cyan))

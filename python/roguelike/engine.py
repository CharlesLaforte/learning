...
def main():
    ...
    max_monsters_per_room = 99
    max_items_per_room = 999
    ...
    fighter_component = Fighter(hp=999, defense=2, power=99)
    ...
    libtcod.console_init_root(screen_width, screen_height, 'ibanyan', False)
    ...
    while not libtcod.console_is_window_closed():
        ...
        for player_turn_result in player_turn_results:
            ...
            if dead_entity:
                # We'll do something here momentarily
